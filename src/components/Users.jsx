...
import gender from '../common/StateData/gender.json';
...
const columns = ({
...
}) => [
  {
    ...
    key: 'userId',
    render: (text) => {
      const index = getAllUsers.findIndex(
        (data) => data.userId === text.userId,
      );
      ...
      return (
        <div className="inline-block">
          ...
          <Button
            ...
            className="user-table-button flex-1"
            type="primary"
            ...
            <div className="top-0 left-0 h-40px flex items-center justify-between flex-3">
              ...
              <div className="flex">
                <Filter
                  ...
                  />
                  <InputFilterField
                    inputValue={filterState.state}
                    inputName="state"
                    handleInputField={handleInputField}
                    placeholder="Enter State"
                  />
                  <InputFilterField
                    inputValue={filterState.agentId}
                    inputName="agentId"
                    handleInputField={handleInputField}
                  ...
                  />
                  <InputFilterField
                    inputValue={filterState.lga}
                    inputName="lga"
                    handleInputField={handleInputField}
                    placeholder="Enter your LGA"
                  />
                  <InputFilterField
                    inputValue={filterState.businessState}
                    inputName="businessState"
                    handleInputField={handleInputField}
                    placeholder="Business State"
                  />
                  <InputFilterField
                    inputValue={filterState.businessLga}
                    inputName="businessLga"
                    handleInputField={handleInputField}
                    placeholder="Business LGA"
                  />
                  <InputFilterField
                    inputValue={filterState.businessCity}
                    inputName="businessCity"
                    handleInputField={handleInputField}
                    placeholder="Business City"
                  />
                  <DropdownFilter
                    paymentMethods={gender}
                    handleFilterInput={handleFilterInput}
                    defaultText="Gender"
                    inputValue={filterState.gender}
                    dropdownName="gender"
                  />
                  <RoleFilter
                    data={filterState}
            ...
            <div className="usersTable">
              <Table
                ...
                columns={columns({
                  ...
                  handleFilterInput,
                  messageType: filterState.messageType,
                  platformType: filterState.platformType,
                  includeImageUrl: filterState.includeImageUrl,
                  handleInputField,
                  actionLink: filterState.actionLink,
                })}
                rowKey="userId"
                pagination={false}
              />
